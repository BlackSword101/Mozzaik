        ...
        return (
            <View style={[styles.container]}>
                ...
                >
                    ...
                    <Text style={[styles.text]}>
                        {'لقد اتى الاسم بالصدفة اثناء مشاهدتي للوحة فسيفسائية (موزاييك) جميلة جدا, وادركت أن سر جمال و اتقان و تميز هذه اللوحة قد تم بفعل تجميع قطع صغيرة جميلة جدا و كل قطعة تمثل لوحة بحد ذاتها, حيث إن جمال اللوحة الكاملة يعكس جمال كل قطعة على حدا, و هذا هو مبدأ عمل شركة موزاييك, فإن شركة موزاييك هي بمثابة اللوحة الفسيفسائية (الموزاييك) الكاملة و المحالات و المصانع و أصحاب المهن يمثلون اللوحات الصغيرة التي سيتم جمعها عن طريق شركة موزاييك لتشكيل اكبر سوق لإيصال هذه المنتجات بأفضل و أسهل و أأمن الطرق من الشرق الأوسط إلى كل منزل بأوروبا.'}
                    </Text>
